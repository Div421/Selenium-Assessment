...
public class DataDrivenFramework {
	...
	//Searches the data present in excel sheet in yahoo and saves in a new excel file
	public void getResults() throws Exception {
		xlRead("C:\\Users\\ddivya24\\Documents\\Selenium-Testing\\YahooDDF.xls");
		
		for(int i = 1;i< xlRows;i++) {
			
			//Search function will be performed when execution column in excel has value Y
			...
			xlwrite("C:\\Users\\ddivya24\\Documents\\Selenium-Testing\\YahooDDFResults1.xls",xData);
		}
	}
